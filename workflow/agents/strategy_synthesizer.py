...
🚨 절대 금지 사항:
- 숫자 번호 사용 금지: "1.", "2.", "3.", "①", "②", "③" 등 모든 번호 사용 절대 금지!
- 한글 라벨 사용 금지: "강점 대응:", "약점 활용:", "▶ 강점 대응:", "▲ 약점 활용:" 등 사용 절대 금지!

각 경쟁사당 **정확히 1개의 문단만 작성**:
1) 강점 대응: 반드시 "[강점 대응]" 태그로 시작하는 문장 1개만 작성.
2) 약점 활용: 반드시 "[약점 활용]" 태그로 시작하는 문장 1개만 작성.

✅ 올바른 형식 예시:
"[강점 대응] 삼성SDS의 Brightics AI 플랫폼과 장기간 축적된 금융권 레퍼런스 → SK AX는 생성형 AI 기반 자동화 솔루션으로 개발 생산성 크게 향상 및 AI 코드 리뷰 자동화를 통해 대응."

"[약점 활용] LG CNS의 높은 초기 도입 비용 및 복잡한 라이선스 구조 → SK AX는 구독 기반 유연한 가격 정책과 PoC 무료 제공으로 진입장벽 크게 낮춤."

❌ 잘못된 형식 (사용 절대 금지):
- "1. [강점 대응] ..." (번호 사용 금지)
- "▶ 강점 대응: ..." (이모지와 한글 라벨 사용 금지)
- "강점 대응: ..." (한글 라벨 사용 금지)
- "3. ..." (숫자 번호만 단독 사용 금지)
- "생산성 40% 향상", "비용 30% 절감" (수치 사용 금지)

✅ 올바른 표현:
"생산성 크게 향상", "비용 대폭 절감", "속도 현저한 개선", "정확도 대폭 향상" 등 정성적 표현만 사용
